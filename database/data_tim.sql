...
(16, 'Non chiamo e non ricevo telefonate', 'Se non riesci né a chiamare, né a ricevere telefonate, alza il ricevitore e verifica attentamente che tipo di segnale ascolti. In base alla fonia che hai ascoltato, segui le indicazioni consigliate per individuare le causa del problema riscontrato.', 2, 0),
